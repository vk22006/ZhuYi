...
<AppShell {activeUrl}>
	...
	<div class="mx-auto max-w-xl space-y-4 pb-6">
		<!-- Counters -->
		...
		<form
			onsubmit={handleAdd}
			class="flex flex-col gap-3 rounded-lg border border-gray-200 bg-white p-4 shadow-sm dark:border-gray-700 dark:bg-gray-800"
		>
			<input
				type="text"
				bind:value={newTitle}
